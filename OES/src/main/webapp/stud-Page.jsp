  ...
  <body>
    ...
    <nav class="main-nav flex-div">
      ...
      <div class="main-nav-right flex-div" id="showprofilemenu">
        ...
        if(session.getAttribute("studStatus").equals("1")){ String sid =
        (String) session.getAttribute("studId"); Student
        sd=DAO.getStudentDetails(sid); %>
    ...
    <jsp:include page="stud-Results.jsp" />
    ...
    <jsp:include page="stud-Dashboard.jsp" />
    <% }else if(request.getParameter("spg").equals("11")) { String startexam =
    request.getParameter("startexam"); session.setAttribute("examStatus", "1");
    session.setAttribute("startexam",startexam);
    response.sendRedirect("paper.jsp"); }else{ %>
    <jsp:include page="stud-exam.jsp" />
    <% } }else response.sendRedirect("Student-Login.jsp?msg=1"); }else
