...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="new">
      <div class="wrapper1">
        <img src="img/20824344_6343825.jpg" alt="Create Instructor" />
      </div>
      <div class="wrapper2">
        <div class="wrapper">
          <div class="title-text">
            <div class="title login">Create Instructor Account</div>
          </div>
          <div class="form-container">
            <div class="form-inner">
              <form
                action="<%= request.getContextPath() %>/controller?page=CreateInstructor"
                method="post"
                class="login"
              >
                <div class="field">
