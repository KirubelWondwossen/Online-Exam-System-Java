<%@page import="com.helper.*"%> <%@page import="com.entity.*"%> <%@page
import="javax.servlet.http.Part"%> <%@page import="java.util.List"%> <%
...
<html lang="en">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/908f7da306.js"
  ...
  <body>
    ...
    <nav class="main-nav flex-div">
      ...
      <div class="main-nav-right flex-div" id="showprofilemenu">
        ...
        if(session.getAttribute("UserStatus").equals("1")){ String id = (String)
        session.getAttribute("UserId"); User user=DAO.getUserDetails(id); %>
        <p class="user-name"><%=user.getUsername() %></p>
        <span class="role-badge"><%=user.getRole().toString() %></span>
        <span class="material-symbols-outlined"> arrow_drop_down </span>
        <span class="material-symbols-outlined"> account_circle </span>
        <%-- <% }else{ response.sendRedirect("User-Login.jsp"); } }else{
      ...
      <div class="settings-menu">
        <div class="setting-inner">
          ...
          <%-- <%if(session.getAttribute("UserStatus")!=null){
          if(session.getAttribute("UserStatus").equals("1")){ String id =
          (String) session.getAttribute("UserId"); User
          user=DAO.getUserDetails(id); %> --%>
    ...
    <div class="main-sidebar">
      <div class="main-sidebar-links">
        <a href="User-Page.jsp?pg=1" class="sidebar-links sidebar-links-1"
          ><i class="fa fa-home" aria-hidden="true"></i>
          <p>Dashboard</p>
        </a>
        <a href="User-Page.jsp?pg=2" class="sidebar-links active"
        ...
        <a href="User-Page.jsp?pg=4" class="sidebar-links"
          ><i class="fa fa-question-circle" aria-hidden="true"></i>
          <p>Question</p>
        </a>
        <a href="User-Page.jsp?pg=5" class="sidebar-links"
          ><i class="fa fa-sticky-note-o" aria-hidden="true"></i>
          <p>Enroll</p>
        </a>
        <a href="User-Page.jsp?pg=6" class="sidebar-links"
          ><i class="fa fa-list-alt" aria-hidden="true"></i>
          <p>Result</p>
        </a>
        <a href="User-Page.jsp?pg=7" class="sidebar-links"
          ><i class="fa fa-list" aria-hidden="true"></i>
          <p>Notice</p>
        </a>
        <a href="User-Page.jsp?pg=8" class="sidebar-links"
          ><i class="fa fa-eye" aria-hidden="true"></i>
          <p>View Exam Attempts</p>
        </a>
    ...
    <% }else if(request.getParameter("pg").equals("8")) { %>
    <jsp:include page="View-Exam-Attempts.jsp" />
    <% }else{ %>
    <jsp:include page="User-Dashboard.jsp" />
    <% } }else response.sendRedirect("User-Login.jsp?msg=1"); }else
